<%@page import="Controller.CheckListCart.ItemData"%>
    ...
    <body class="animsition">
        ...
        <script>
            ...
            selectedItems.forEach(item => {
                ...
                const total = item.price * 1; // Assuming quantity is 1 for now
                ...
                row.innerHTML = `
                    ...
                    <td class="column-4">
                        <div class="wrap-num-product flex-w m-l-auto m-r-0">
                            ...
                            <input class="mtext-104 cl3 txt-center num-product" type="number" name="num-product-1" value="1" />
                            <div class="btn-num-product-up cl8 hov-btn3 trans-04 flex-c-m">
                                <i class="fs-16 zmdi zmdi-plus"></i>
                            </div>
                        </div>
                    </td>
                    <td class="column-5">$ ${total.toFixed(2)}</td>
                `;
